...
def displayMenuSelection(screen, screen_size, choice, bg_colour, a_colour, na_colour):
        ...
        if choice == 0:
                displayMessage("Maze Game", na_colour, screen, 50, screen_size, screen_size[1]//5)
...
def startScreen():
        ...
        displayMenuSelection(screen, screen_size, 0, GOLD, WHITE, BLACK)
        ...
        while carryOn:
                ...
                if (pygame.time.get_ticks() - start_timer > cooldown):
                        if current_selection == options[0]:
                                ...
                                if keys[pygame.K_DOWN]:
                                        # display selection 1
                                        displayMenuSelection(screen, screen_size, 1, GOLD, WHITE, BLACK)
                                        current_selection = options[1]
                                        # restart cooldown timer
                                        start_timer = pygame.time.get_ticks()
                                ...
                                if keys[pygame.K_DOWN]:
                                        # display selection 2
                                        displayMenuSelection(screen, screen_size, 2, GOLD, WHITE, BLACK)
                                        current_selection = options[2]
                                        start_timer = pygame.time.get_ticks()
                                if keys[pygame.K_RETURN]:
                                        Settings = True
                ...
                if Settings:
                        grid_size, side_length, mode = settingsMenu(screen, screen_size, GOLD, WHITE, BLACK, cooldown,\
